// DuckGenesisHook event handlers. Generated by gen_subgraphs.py; edit the generator, not this file.
import {
  BuybackBurned,
  CreatorTransferred,
  FeeSplitsUpdated,
  ...
  StateViewSet,
  VaultCutSkipped,
} from "../generated/DuckGenesisHook/DuckGenesisHook";
...
const CONTRACT = "DuckGenesisHook";
...
// DuckGenesisHook has no paid takeover; only the owner moves a pool's creator.
export function handleCreatorTransferred(event: CreatorTransferred): void {
