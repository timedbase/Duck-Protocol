...
export function handleCampaignAccessSet(event: CampaignAccessSet): void {
  logAdminEvent(event, CONTRACT, "CampaignAccessSet", event.params.campaignId.toString(), event.params.mode.toString(), event.params.maxPerWallet.toString(), event.params.whitelistRoot.toHexString() + "|" + event.params.whitelistURI);
}
