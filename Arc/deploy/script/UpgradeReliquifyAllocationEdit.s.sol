...
//
//   forge script script/UpgradeReliquifyAllocationEdit.s.sol --rpc-url arc --account duck-deployer \
...
contract UpgradeReliquifyAllocationEdit is Script {
    ...
    bytes32 constant SALT_IMPL = keccak256("duckfun.arc.v4.DuckReliquify.impl");
